...
namespace DocuSign.Core.Api
{
    ...
    public interface ITemplatesApi : IApiAccessor
    {
        ...
        /// <param name="modifiedFromDate"> (optional)</param>
        /// <param name="modifiedToDate"> (optional)</param>
        ...
        EnvelopeTemplateResults TemplatesGetTemplates (string accountId, string count = null, string folder = null, string folderIds = null, string fromDate = null, string include = null, string modifiedFromDate = null, string modifiedToDate = null, string order = null, string orderBy = null, string searchText = null, string sharedByMe = null, string startPosition = null, string toDate = null, string usedFromDate = null, string usedToDate = null, string userFilter = null, string userId = null);
    ...
    public partial class TemplatesApi : ITemplatesApi
    {
        ...
        {
             ApiResponse<EnvelopeTemplateResults> localVarResponse = TemplatesGetTemplatesWithHttpInfo(accountId, count, folder, folderIds, fromDate, include, modifiedFromDate, modifiedToDate, order, orderBy, searchText, sharedByMe, startPosition, toDate, usedFromDate, usedToDate, userFilter, userId);
             return localVarResponse.Data;
        }
        ...
        public ApiResponse< EnvelopeTemplateResults > TemplatesGetTemplatesWithHttpInfo (string accountId, string count = null, string folder = null, string folderIds = null, string fromDate = null, string include = null, string modifiedFromDate = null, string modifiedToDate = null, string order = null, string orderBy = null, string searchText = null, string sharedByMe = null, string startPosition = null, string toDate = null, string usedFromDate = null, string usedToDate = null, string userFilter = null, string userId = null)
        {
            ...
            if (include != null) localVarQueryParams.Add("include", Configuration.ApiClient.ParameterToString(include)); // query parameter
            if (modifiedFromDate != null) localVarQueryParams.Add("modified_from_date", Configuration.ApiClient.ParameterToString(modifiedFromDate)); // query parameter
            if (modifiedToDate != null) localVarQueryParams.Add("modified_to_date", Configuration.ApiClient.ParameterToString(modifiedToDate)); // query parameter
        ...
        {
             ApiResponse<EnvelopeTemplateResults> localVarResponse = await TemplatesGetTemplatesAsyncWithHttpInfo(accountId, count, folder, folderIds, fromDate, include, modifiedFromDate, modifiedToDate, order, orderBy, searchText, sharedByMe, startPosition, toDate, usedFromDate, usedToDate, userFilter, userId);
             return localVarResponse.Data;
        ...
        /// <summary>
        /// Creates a template. Creates a template definition using a multipart request.  ### Template Email Subject Merge Fields  Call this endpoint to insert a recipient name and email address merge fields into the email subject line when creating or sending from a template.  The merge fields, based on the recipient&#39;s role name, are added to the &#x60;emailSubject&#x60; property when the template is created or when the template is used to create an envelope. After a template sender adds the name and email information for the recipient and sends the envelope, the recipient information is automatically merged into the appropriate fields in the email subject line.  Both the sender and the recipients will see the information in the email subject line for any emails associated with the template. This provides an easy way for senders to organize their envelope emails without having to open an envelope to check the recipient.   ###### If merging the recipient information into the subject line causes the subject line to exceed 100 characters, then any characters over the 100 character limit are not included in the subject line. For cases where the recipient name or email is expected to be long, you should consider placing the merge field at the start of the email subject.  To add a recipient&#39;s name in the subject line add the following text in the &#x60;emailSubject&#x60; property when creating the template or when sending an envelope from a template:  &#x60;[[&lt;roleName&gt;_UserName]]&#x60;  Example:  &#x60;\&quot;emailSubject\&quot;:\&quot;[[Signer 1_UserName]], Please sign this NDA\&quot;,&#x60;  To add a recipient&#39;s email address in the subject line add the following text in the &#x60;emailSubject&#x60; property when creating the template or when sending an envelope from a template:  &#x60;[[&lt;roleName&gt;_Email]]&#x60;  Example:  &#x60;\&quot;emailSubject\&quot;:\&quot;[[Signer 1_Email]], Please sign this NDA\&quot;,&#x60;   In both cases the &lt;roleName&gt; is the recipient&#39;s contents of the &#x60;roleName&#x60; property in the template.  For cases where another recipient (such as an Agent, Editor, or Intermediary recipient) is entering the name and email information for the recipient included in the email subject, then &#x60;[[&lt;roleName&gt;_UserName]]&#x60; or &#x60;[[&lt;roleName&gt;_Email]]&#x60; is shown in the email subject.
        /// </summary>
        /// <exception cref="DocuSign.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountId">The external account number (int) or account ID Guid.</param>
        /// <param name="templates"> (optional)</param>
