...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SignatureProviderRequiredOption :  IEquatable<SignatureProviderRequiredOption>
    {
        /// <summary>
        ...
        public SignatureProviderRequiredOption(List<string> RequiredSignatureProviderOptionIds = null, string SignerType = null)
        {
