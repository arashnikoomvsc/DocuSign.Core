...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FolderItemResponse :  IEquatable<FolderItemResponse>
    {
        /// <summary>
        ...
        public FolderItemResponse(string EndPosition = null, List<FolderItemV2> FolderItems = null, string NextUri = null, string PreviousUri = null, string ResultSetSize = null, string StartPosition = null, string TotalRows = null)
        {
