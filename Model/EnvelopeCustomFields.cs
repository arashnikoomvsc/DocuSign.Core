...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnvelopeCustomFields :  IEquatable<EnvelopeCustomFields>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvelopeCustomFields" /> class.
        /// </summary>
        ...
        public EnvelopeCustomFields(List<ListCustomField> ListCustomFields = null, List<TextCustomField> TextCustomFields = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnvelopeCustomFields {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EnvelopeCustomFields);
        }

        /// <summary>
        /// Returns true if EnvelopeCustomFields instances are equal
        /// </summary>
        /// <param name="other">Instance of EnvelopeCustomFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvelopeCustomFields other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
