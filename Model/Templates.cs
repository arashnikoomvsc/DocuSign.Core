...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Templates :  IEquatable<Templates>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>A complex element containing the following information:  templateId: Unique identifier of the template. If this is not provided, DocuSign will generate a value.   name: Name of the template. Maximum length: 100 characters.  shared: When set to **true**, the template is shared with the Everyone group in the account. If false, the template is only shared with the Administrator group.  password: Password, if the template is locked.  description: Description of the template. Maximum Length: 500 characters.  pageCount: Number of document pages in the template.  folderName: The name of the folder the template is located in.  folderId: The ID for the folder.  owner: The userName, email, userId, userType, and userStatus for the template owner. </value>
        [DataMember(Name="envelopeTemplateDefinition", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EnvelopeTemplateDefinition: ").Append(EnvelopeTemplateDefinition).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Templates);
        }

        /// <summary>
        /// Returns true if Templates instances are equal
        /// </summary>
        /// <param name="other">Instance of Templates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Templates other)
        {
            ...
            return 
                ...
                (
                    this.EnvelopeTemplateDefinition == other.EnvelopeTemplateDefinition ||
                    this.EnvelopeTemplateDefinition != null &&
                    this.EnvelopeTemplateDefinition.Equals(other.EnvelopeTemplateDefinition)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnvelopeTemplateDefinition != null)
                    hash = hash * 59 + this.EnvelopeTemplateDefinition.GetHashCode();
