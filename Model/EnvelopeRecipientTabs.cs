...
namespace DocuSign.Core.Model
{
	...
	/// </summary>
	[DataContract]
	public partial class EnvelopeRecipientTabs : IEquatable<EnvelopeRecipientTabs>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="EnvelopeRecipientTabs" /> class.
		/// </summary>
		...
		public override string ToString ()
		{
			...
			sb.Append("class EnvelopeRecipientTabs {\n");
		...
		public override bool Equals (object obj)
		{
			...
			return this.Equals(obj as EnvelopeRecipientTabs);
		}

		/// <summary>
		/// Returns true if EnvelopeRecipientTabs instances are equal
		/// </summary>
		/// <param name="other">Instance of EnvelopeRecipientTabs to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals (EnvelopeRecipientTabs other)
		{
			// credit: http://stackoverflow.com/a/10454552/677735
			if (other == null)
				return false;
