...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserCustomSettings :  IEquatable<UserCustomSettings>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserCustomSettings" /> class.
        /// </summary>
        /// <param name="CustomSettings">The name/value pair information for the user custom setting..</param>
        public UserCustomSettings(List<NameValue> CustomSettings = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserCustomSettings {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserCustomSettings);
        }

        /// <summary>
        /// Returns true if UserCustomSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of UserCustomSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserCustomSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
