...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SeatDiscount :  IEquatable<SeatDiscount>
    {
        /// <summary>
        ...
        public SeatDiscount(string BeginSeatCount = null, string DiscountPercent = null, string EndSeatCount = null)
        {
