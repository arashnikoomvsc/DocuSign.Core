...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PowerForms :  IEquatable<PowerForms>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PowerForms);
        }

        /// <summary>
        /// Returns true if PowerForms instances are equal
        /// </summary>
        /// <param name="other">Instance of PowerForms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PowerForms other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
