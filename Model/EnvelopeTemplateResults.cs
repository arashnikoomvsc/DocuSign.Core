...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnvelopeTemplateResults :  IEquatable<EnvelopeTemplateResults>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvelopeTemplateResults" /> class.
        /// </summary>
        /// <param name="EndPosition">The last position in the result set. .</param>
        /// <param name="EnvelopeTemplates">The list of requested templates..</param>
        ...
        public EnvelopeTemplateResults(string EndPosition = null, List<EnvelopeTemplateResult> EnvelopeTemplates = null, List<Folder> Folders = null, string NextUri = null, string PreviousUri = null, string ResultSetSize = null, string StartPosition = null, string TotalSetSize = null)
        {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnvelopeTemplates != null)
                    hash = hash * 59 + this.EnvelopeTemplates.GetHashCode();
