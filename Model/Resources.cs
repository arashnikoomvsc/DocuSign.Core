...
namespace DocuSign.Core.Model
{
    ...
    public partial class Resources :  IEquatable<Resources>
    {
        ...
        public Resources(List<NameValue> _Resources = null)
        {
        ...
        public List<NameValue> _Resources { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Resources: ").Append(_Resources).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Resources other)
        {
            ...
            return 
                (
                    ...
                    this._Resources.SequenceEqual(other._Resources)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Resources != null)
                    hash = hash * 59 + this._Resources.GetHashCode();
                return hash;
            }
        }
    }
