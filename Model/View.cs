...
namespace DocuSign.Core.Model
{
    ...
    public partial class View :  IEquatable<View>
    {
        ...
        public View(string AnchorCaseSensitive = null, string AnchorHorizontalAlignment = null, string AnchorIgnoreIfNotPresent = null, string AnchorMatchWholeWord = null, string AnchorString = null, string AnchorUnits = null, string AnchorXOffset = null, string AnchorYOffset = null, string Bold = null, string ButtonText = null, string ConditionalParentLabel = null, string ConditionalParentValue = null, string CustomTabId = null, string DocumentId = null, ErrorDetails ErrorDetails = null, string Font = null, string FontColor = null, string FontSize = null, int? Height = null, string Italic = null, MergeField MergeField = null, string PageNumber = null, string RecipientId = null, string Required = null, string RequiredRead = null, string Status = null, string TabId = null, string TabLabel = null, string TabOrder = null, string TemplateLocked = null, string TemplateRequired = null, string Underline = null, int? Width = null, string XPosition = null, string YPosition = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RequiredRead: ").Append(RequiredRead).Append("\n");
        ...
        public bool Equals(View other)
        {
            ...
            return 
                ...
                (
                    this.RequiredRead == other.RequiredRead ||
                    this.RequiredRead != null &&
                    this.RequiredRead.Equals(other.RequiredRead)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RequiredRead != null)
                    hash = hash * 59 + this.RequiredRead.GetHashCode();
                if (this.Status != null)
