...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateSharedItem :  IEquatable<TemplateSharedItem>
    {
        /// <summary>
        ...
        public TemplateSharedItem(ErrorDetails ErrorDetails = null, UserInfo Owner = null, string Shared = null, List<MemberGroupSharedItem> SharedGroups = null, List<UserSharedItem> SharedUsers = null, string TemplateId = null, string TemplateName = null)
        {
