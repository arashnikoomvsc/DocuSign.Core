...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountBrands :  IEquatable<AccountBrands>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountBrands" /> class.
        /// </summary>
        ...
        public AccountBrands(List<Brand> Brands = null, string RecipientBrandIdDefault = null, string SenderBrandIdDefault = null)
        {
            this.Brands = Brands;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AccountBrands);
        }

        /// <summary>
        /// Returns true if AccountBrands instances are equal
        /// </summary>
        /// <param name="other">Instance of AccountBrands to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountBrands other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
