...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PowerFormSendersResponse :  IEquatable<PowerFormSendersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PowerFormSendersResponse" /> class.
        /// </summary>
        ...
        /// <param name="PowerFormSenders">.</param>
        ...
        public PowerFormSendersResponse(string EndPosition = null, string NextUri = null, List<UserInfo> PowerFormSenders = null, string PreviousUri = null, string ResultSetSize = null, string StartPosition = null, string TotalSetSize = null)
        {
        ...
        /// </summary>
        /// <value></value>
        [DataMember(Name="powerFormSenders", EmitDefaultValue=false)]
        public List<UserInfo> PowerFormSenders { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PowerFormSenders: ").Append(PowerFormSenders).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PowerFormSendersResponse);
        }

        /// <summary>
        /// Returns true if PowerFormSendersResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PowerFormSendersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PowerFormSendersResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.PowerFormSenders == other.PowerFormSenders ||
                    this.PowerFormSenders != null &&
                    this.PowerFormSenders.SequenceEqual(other.PowerFormSenders)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PowerFormSenders != null)
                    hash = hash * 59 + this.PowerFormSenders.GetHashCode();
