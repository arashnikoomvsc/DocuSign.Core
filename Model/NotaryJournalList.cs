...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NotaryJournalList :  IEquatable<NotaryJournalList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotaryJournalList" /> class.
        /// </summary>
        ...
        /// <param name="NotaryJournals">.</param>
        ...
        public NotaryJournalList(string EndPosition = null, string NextUri = null, List<NotaryJournals> NotaryJournals = null, string PreviousUri = null, string ResultSetSize = null, string StartPosition = null, string TotalSetSize = null)
        {
        ...
        /// </summary>
        /// <value></value>
        [DataMember(Name="notaryJournals", EmitDefaultValue=false)]
        public List<NotaryJournals> NotaryJournals { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NotaryJournals: ").Append(NotaryJournals).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NotaryJournalList);
        }

        /// <summary>
        /// Returns true if NotaryJournalList instances are equal
        /// </summary>
        /// <param name="other">Instance of NotaryJournalList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotaryJournalList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.NotaryJournals == other.NotaryJournals ||
                    this.NotaryJournals != null &&
                    this.NotaryJournals.SequenceEqual(other.NotaryJournals)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NotaryJournals != null)
                    hash = hash * 59 + this.NotaryJournals.GetHashCode();
