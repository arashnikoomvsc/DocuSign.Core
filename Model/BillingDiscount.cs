...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BillingDiscount :  IEquatable<BillingDiscount>
    {
        /// <summary>
        ...
        public BillingDiscount(string BeginQuantity = null, string Discount = null, string EndQuantity = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BillingDiscount);
        }

        /// <summary>
        /// Returns true if BillingDiscount instances are equal
        /// </summary>
        /// <param name="other">Instance of BillingDiscount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillingDiscount other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
