...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnvelopeConsumerDisclosures :  IEquatable<EnvelopeConsumerDisclosures>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvelopeConsumerDisclosures" /> class.
        /// </summary>
        ...
        /// <param name="AllowCDWithdrawMetadata">.</param>
        ...
        /// <param name="UseConsumerDisclosureWithinAccountMetadata">.</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnvelopeConsumerDisclosures {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EnvelopeConsumerDisclosures);
        }

        /// <summary>
        /// Returns true if EnvelopeConsumerDisclosures instances are equal
        /// </summary>
        /// <param name="other">Instance of EnvelopeConsumerDisclosures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvelopeConsumerDisclosures other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
