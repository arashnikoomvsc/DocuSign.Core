...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConnectConfigurations :  IEquatable<ConnectConfigurations>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectConfigurations" /> class.
        /// </summary>
        ...
        /// <param name="ConnectId"> Read only: the DocuSign generated ID for the Connect configuration.  .</param>
        ...
        /// <param name="RecipientEvents">A comma separated list of *Recipient* related events that will trigger a notification to your webhook Connect listener. The possible event values are: Sent, Delivered, Completed, Declined, AuthenticationFailed, and AutoResponded..</param>
        /// <param name="RequiresAcknowledgement">#### When set to **true**, and SIM mode is activated:  If the HTTP Status response to a notification message is not in the range of 200-299 then the message delivery failed, and the configuration is marked as *down.*  The message will be queued and retried once per day. While a Connect configuration is marked down, subsequent notifications will not be tried, they&#39;ll be immediately queued with reason \&quot;Pending.\&quot; Once a message succeeds, all queued messages for the configuration will be tried immediately, in order.  There is a maximum of ten retries Alternately, you can use Republish Connect Information to manually republish the notification.  #### When set to **true**, and SIM mode is not activated:   If the HTTP Status response to a notification message is not in the range of 200-299 then the message delivery failed, and the message is queued.  The message will be retried after at least a day the next time a subsequent message is successfully sent to this configuration (subscription).  Subsequent notifications will be tried when they occur. There is a maximum of ten retries Alternately, you can use Republish Connect Information to manually republish the notification..</param>
        /// <param name="SignMessageWithX509Certificate">When set to **true**, Mutual TLS will be enabled for notifications. Mutual TLS must be initiated by the listener (the customer&#39;s web server) during the TLS handshake protocol. .</param>
        ...
        /// <param name="UrlToPublishTo">The endpoint to which webhook notification messages are sent via an HTTPS POST request. The url must start with https. The customer&#39;s web server must use an SSL/TLS certificate whose CA is in the Microsoft list of trusted CAs. Self-signed certificates are not ok. Free certificates from Let&#39;s Encrypt can be used..</param>
        /// <param name="UserIds">A comma separated list of userIds. This sets the users associated with the tracked envelope and recipient events. When a tracked event occurs for a set user, the a notification message is sent to your Connect listener.   ###### Note: If allUsers is set to &#x60;false&#x60; then you must provide a list of user ids..</param>
        /// <param name="UseSoapInterface">When set to **true**, indicates that the &#x60;urlToPublishTo&#x60; property contains a SOAP endpoint..</param>
        public ConnectConfigurations(string AllowEnvelopePublish = null, string AllUsers = null, string ConfigurationType = null, string ConnectId = null, string EnableLog = null, string EnvelopeEvents = null, string IncludeCertificateOfCompletion = null, string IncludeCertSoapHeader = null, string IncludeDocumentFields = null, string IncludeDocuments = null, string IncludeEnvelopeVoidReason = null, string IncludeSenderAccountasCustomField = null, string IncludeTimeZoneInformation = null, string Name = null, string RecipientEvents = null, string RequiresAcknowledgement = null, string SignMessageWithX509Certificate = null, string SoapNamespace = null, string UrlToPublishTo = null, string UserIds = null, string UseSoapInterface = null)
        {
        ...
        /// </summary>
        /// <value> Read only: the DocuSign generated ID for the Connect configuration.  </value>
        ...
        /// </summary>
        /// <value>A comma separated list of *Recipient* related events that will trigger a notification to your webhook Connect listener. The possible event values are: Sent, Delivered, Completed, Declined, AuthenticationFailed, and AutoResponded.</value>
        ...
        /// </summary>
        /// <value>#### When set to **true**, and SIM mode is activated:  If the HTTP Status response to a notification message is not in the range of 200-299 then the message delivery failed, and the configuration is marked as *down.*  The message will be queued and retried once per day. While a Connect configuration is marked down, subsequent notifications will not be tried, they&#39;ll be immediately queued with reason \&quot;Pending.\&quot; Once a message succeeds, all queued messages for the configuration will be tried immediately, in order.  There is a maximum of ten retries Alternately, you can use Republish Connect Information to manually republish the notification.  #### When set to **true**, and SIM mode is not activated:   If the HTTP Status response to a notification message is not in the range of 200-299 then the message delivery failed, and the message is queued.  The message will be retried after at least a day the next time a subsequent message is successfully sent to this configuration (subscription).  Subsequent notifications will be tried when they occur. There is a maximum of ten retries Alternately, you can use Republish Connect Information to manually republish the notification.</value>
        ...
        /// </summary>
        /// <value>A comma separated list of userIds. This sets the users associated with the tracked envelope and recipient events. When a tracked event occurs for a set user, the a notification message is sent to your Connect listener.   ###### Note: If allUsers is set to &#x60;false&#x60; then you must provide a list of user ids.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConnectConfigurations {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConnectConfigurations);
        }

        /// <summary>
        /// Returns true if ConnectConfigurations instances are equal
        /// </summary>
        /// <param name="other">Instance of ConnectConfigurations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectConfigurations other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
