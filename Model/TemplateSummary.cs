...
namespace DocuSign.Core.Model
{
    ...
    public partial class TemplateSummary :  IEquatable<TemplateSummary>
    {
        ...
        /// <param name="TemplateMatch">.</param>
        /// <param name="Uri">.</param>
        public TemplateSummary(string Applied = null, string DocumentId = null, string DocumentName = null, string Name = null, string TemplateId = null, TemplateMatch TemplateMatch = null, string Uri = null)
        {
