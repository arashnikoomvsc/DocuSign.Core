...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateBulkRecipients :  IEquatable<TemplateBulkRecipients>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateBulkRecipients" /> class.
        /// </summary>
        ...
        public TemplateBulkRecipients(List<BulkRecipient> BulkRecipients = null, string EndPosition = null, string NextUri = null, string PreviousUri = null, string ResultSetSize = null, string StartPosition = null, string TotalSetSize = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplateBulkRecipients {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TemplateBulkRecipients);
        }

        /// <summary>
        /// Returns true if TemplateBulkRecipients instances are equal
        /// </summary>
        /// <param name="other">Instance of TemplateBulkRecipients to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateBulkRecipients other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
