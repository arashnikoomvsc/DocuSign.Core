...
namespace DocuSign.Core.Model
{
    ...
    public partial class Invoices :  IEquatable<Invoices>
    {
        ...
        public Invoices(string Amount = null, string Balance = null, string DueDate = null, string InvoiceId = null, List<BillingInvoiceItem> InvoiceItems = null, string InvoiceNumber = null, string InvoiceUri = null, string NonTaxableAmount = null, string PdfAvailable = null, string TaxableAmount = null)
        {
            this.Amount = Amount;
