...
namespace DocuSign.Core.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChunkedUploads" /> class.
        /// </summary>
        ...
        public ChunkedUploads(string Checksum = null, string ChunkedUploadId = null, List<ChunkedUploadPart> ChunkedUploadParts = null, string ChunkedUploadUri = null, string Committed = null, string ExpirationDateTime = null, string MaxChunkedUploadParts = null, string MaxTotalSize = null, string TotalSize = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChunkedUploads {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ChunkedUploads);
        }

        /// <summary>
        /// Returns true if ChunkedUploads instances are equal
        /// </summary>
        /// <param name="other">Instance of ChunkedUploads to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChunkedUploads other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
