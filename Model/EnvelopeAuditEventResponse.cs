...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnvelopeAuditEventResponse :  IEquatable<EnvelopeAuditEventResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvelopeAuditEventResponse" /> class.
        /// </summary>
        /// <param name="AuditEvents">Reserved: TBD.</param>
        public EnvelopeAuditEventResponse(List<EnvelopeAuditEvent> AuditEvents = null)
        {
