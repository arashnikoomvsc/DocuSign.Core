...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CloudStorageProvider :  IEquatable<CloudStorageProvider>
    {
        /// <summary>
        ...
        public CloudStorageProvider(string AuthenticationUrl = null, ErrorDetails ErrorDetails = null, string RedirectUrl = null, string Service = null, string ServiceId = null)
        {
