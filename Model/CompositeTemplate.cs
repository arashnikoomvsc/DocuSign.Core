...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompositeTemplate :  IEquatable<CompositeTemplate>
    {
        /// <summary>
        ...
        public CompositeTemplate(string CompositeTemplateId = null, Document Document = null, List<InlineTemplate> InlineTemplates = null, string PdfMetaDataTemplateSequence = null, List<ServerTemplate> ServerTemplates = null)
        {
