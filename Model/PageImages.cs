...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageImages :  IEquatable<PageImages>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageImages" /> class.
        /// </summary>
        ...
        public PageImages(string EndPosition = null, string NextUri = null, List<Page> Pages = null, string PreviousUri = null, string ResultSetSize = null, string StartPosition = null, string TotalSetSize = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageImages);
        }

        /// <summary>
        /// Returns true if PageImages instances are equal
        /// </summary>
        /// <param name="other">Instance of PageImages to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageImages other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
