...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountSignatureProviderOption :  IEquatable<AccountSignatureProviderOption>
    {
        /// <summary>
        ...
        public AccountSignatureProviderOption(string SignatureProviderOptionDisplayName = null, string SignatureProviderOptionId = null, string SignatureProviderOptionName = null)
        {
