...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateLocks :  IEquatable<TemplateLocks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateLocks" /> class.
        /// </summary>
        ...
        public TemplateLocks(ErrorDetails ErrorDetails = null, string LockDurationInSeconds = null, string LockedByApp = null, UserInfo LockedByUser = null, string LockedUntilDateTime = null, string LockToken = null, string LockType = null, string UseScratchPad = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TemplateLocks);
        }

        /// <summary>
        /// Returns true if TemplateLocks instances are equal
        /// </summary>
        /// <param name="other">Instance of TemplateLocks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateLocks other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
