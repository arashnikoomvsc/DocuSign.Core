...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConnectFailureFilter :  IEquatable<ConnectFailureFilter>
    {
        /// <summary>
        ...
        public ConnectFailureFilter(List<string> EnvelopeIds = null, string Synchronous = null)
        {
