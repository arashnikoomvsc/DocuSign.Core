...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountCustomFields :  IEquatable<AccountCustomFields>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountCustomFields" /> class.
        /// </summary>
        ...
        public AccountCustomFields(List<ListCustomField> ListCustomFields = null, List<TextCustomField> TextCustomFields = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountCustomFields {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AccountCustomFields);
        }

        /// <summary>
        /// Returns true if AccountCustomFields instances are equal
        /// </summary>
        /// <param name="other">Instance of AccountCustomFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountCustomFields other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
