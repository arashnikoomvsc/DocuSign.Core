...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PowerFormsResponse :  IEquatable<PowerFormsResponse>
    {
        /// <summary>
        ...
        public PowerFormsResponse(string EndPosition = null, string NextUri = null, List<PowerForms> PowerForms = null, string PreviousUri = null, string ResultSetSize = null, string StartPosition = null, string TotalSetSize = null)
        {
        ...
        public List<PowerForms> PowerForms { get; set; }
        /// <summary>
