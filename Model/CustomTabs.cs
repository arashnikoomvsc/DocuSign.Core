...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomTabs :  IEquatable<CustomTabs>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The type of this tab. Values are:  - Approve - CheckBox - Company - Date - DateSigned, Decline - Email, EmailAddress - EnvelopeId - FirstName - Formula - FullName, InitialHere - InitialHereOptional - LastName - List - Note - Number - Radio - SignerAttachment - SignHere - SignHereOptional - Ssn - Text - Title - Zip5 - Zip5Dash4 </value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CustomTabs);
        }

        /// <summary>
        /// Returns true if CustomTabs instances are equal
        /// </summary>
        /// <param name="other">Instance of CustomTabs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomTabs other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
