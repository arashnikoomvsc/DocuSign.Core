...
namespace DocuSign.Core.Model
{
    ...
    public partial class Signer :  IEquatable<Signer>
    {
        ...
        /// <param name="Note">A note sent to the recipient in the signing email. This note is unique to this recipient. In the user interface, it appears near the upper left corner of the document on the signing screen.  Maximum Length: 1000 characters. .</param>
        ...
        /// <param name="SignInEachLocation">When set to **true** and the feature is enabled in the sender&#39;s account, the signing recipient is required to draw signatures and initials at each signature/initial tab (instead of adopting a signature/initial style or only drawing a signature/initial once)..</param>
        ...
        /// <param name="Status">Recipient status. &lt;!- - todo - -&gt; .</param>
        ...
        public Signer(string AccessCode = null, string AddAccessCodeToEmail = null, string AutoNavigation = null, string BulkRecipientsUri = null, string CanSignOffline = null, string ClientUserId = null, string CreationReason = null, List<string> CustomFields = null, string DeclinedDateTime = null, string DeclinedReason = null, string DefaultRecipient = null, string DeliveredDateTime = null, string DeliveryMethod = null, List<DocumentVisibility> DocumentVisibility = null, string Email = null, RecipientEmailNotification EmailNotification = null, string EmailRecipientPostSigningURL = null, string EmbeddedRecipientStartURL = null, ErrorDetails ErrorDetails = null, List<string> ExcludedDocuments = null, string FaxNumber = null, string IdCheckConfigurationName = null, IdCheckInformationInput IdCheckInformationInput = null, string InheritEmailNotificationConfiguration = null, string IsBulkRecipient = null, string Name = null, string Note = null, RecipientPhoneAuthentication PhoneAuthentication = null, List<RecipientAttachment> RecipientAttachments = null, AuthenticationStatus RecipientAuthenticationStatus = null, string RecipientId = null, string RecipientIdGuid = null, List<RecipientSignatureProvider> RecipientSignatureProviders = null, string RecipientSuppliesTabs = null, string RequireIdLookup = null, string RequireSignerCertificate = null, string RequireSignOnPaper = null, string RoleName = null, string RoutingOrder = null, RecipientSAMLAuthentication SamlAuthentication = null, string SentDateTime = null, RecipientSignatureInformation SignatureInfo = null, string SignedDateTime = null, string SignInEachLocation = null, string SigningGroupId = null, string SigningGroupName = null, List<UserInfo> SigningGroupUsers = null, RecipientSMSAuthentication SmsAuthentication = null, List<SocialAuthentication> SocialAuthentications = null, string Status = null, EnvelopeRecipientTabs Tabs = null, string TemplateLocked = null, string TemplateRequired = null, string TotalTabCount = null, string UserId = null)
        {
        ...
        /// </summary>
        /// <value>A note sent to the recipient in the signing email. This note is unique to this recipient. In the user interface, it appears near the upper left corner of the document on the signing screen.  Maximum Length: 1000 characters. </value>
        ...
        /// <summary>
        /// Recipient status. &lt;!- - todo - -&gt; 
        /// </summary>
        /// <value>Recipient status. &lt;!- - todo - -&gt; </value>
