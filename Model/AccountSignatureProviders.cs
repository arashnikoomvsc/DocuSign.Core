...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountSignatureProviders :  IEquatable<AccountSignatureProviders>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountSignatureProviders" /> class.
        /// </summary>
        /// <param name="SignatureProviders">.</param>
        public AccountSignatureProviders(List<AccountSignatureProvider> SignatureProviders = null)
        {
