...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountConsumerDisclosures :  IEquatable<AccountConsumerDisclosures>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountConsumerDisclosures" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConsumerDisclosures {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AccountConsumerDisclosures);
        }

        /// <summary>
        /// Returns true if AccountConsumerDisclosures instances are equal
        /// </summary>
        /// <param name="other">Instance of AccountConsumerDisclosures to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConsumerDisclosures other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
