...
namespace DocuSign.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnvelopeLocks :  IEquatable<EnvelopeLocks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvelopeLocks" /> class.
        /// </summary>
        ...
        public EnvelopeLocks(ErrorDetails ErrorDetails = null, string LockDurationInSeconds = null, string LockedByApp = null, UserInfo LockedByUser = null, string LockedUntilDateTime = null, string LockToken = null, string LockType = null, string UseScratchPad = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EnvelopeLocks);
        }

        /// <summary>
        /// Returns true if EnvelopeLocks instances are equal
        /// </summary>
        /// <param name="other">Instance of EnvelopeLocks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvelopeLocks other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
